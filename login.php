		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="public/img/logo_fres.jpg" alt="IMG">
				</div>

				<form method="POST" class="login100-form validate-form" action="services/autenticaUser.php" >
                ...
                ?>
					...
					<div class="wrap-input100 validate-input" data-validate = "Necessário um e-mail valido: ex@ex.com">
						<input class="input100" type="text" name="usuarioEmail" placeholder="Usuário">
